    ...
    <main className="min-h-screen bg-[#f5f5f7]">
        ...
        <div className="container-main mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            >
              ...
              >
                Tinggalkan cara manual. EduCraft AI membedah materi Anda menjadi evaluasi berstandar Taksonomi Bloom. Anda memegang kendali penuh untuk memilih level kesulitan soal (HOTS/LOTS), dan hasil akhirnya langsung siap untuk dicetak.
              </motion.p>
              
              <motion.div variants={ANIMASI_FADE_UP} className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
                <Link href="/register" className="btn-primary px-8 py-4 w-full sm:w-auto flex items-center justify-center gap-3 rounded-none bg-black hover:bg-gray-800 text-white shadow-[4px_4px_0px_0px_rgba(0,0,0,0.2)] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,0.2)] transition-all">
                  Mulai Membuat Soal
                ...
                <div className="flex items-center gap-3 text-sm text-gray-500 mt-4 sm:mt-0 px-4">
                  <div className="flex -space-x-2">
                    ...
                    <div className="w-8 h-8 rounded-full bg-gray-400 border-2 border-white flex items-center justify-center text-[10px] text-white font-bold">+</div>
                  </div>
              ...
              <div className="relative w-full max-w-md bg-white border border-black/10 shadow-2xl p-6 flex flex-col gap-4 transform rotate-1 hover:rotate-0 transition-transform duration-500 z-10">
                <div className="flex items-center justify-between border-b border-black/5 pb-4">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-black text-white flex items-center justify-center font-editorial text-xl">PDF</div>
                    <div>
                      <div className="text-sm font-semibold text-black">Modul_Biologi_Bab4.pdf</div>
                ...
                <div className="mt-4 p-4 bg-[#f9f9f9] border border-black/5">
                  <span className="text-xs font-bold text-black uppercase tracking-wider mb-2 block">Hasil AI (HOTS - C4)</span>
                  <p className="text-sm text-gray-600 font-serif italic">
                    "Jika mutasi genetik terjadi pada sel somatik, mengapa hal tersebut tidak diturunkan ke generasi berikutnya?"
                  </p>
                </div>
              </div>
              <div className="absolute -bottom-6 md:bottom-24 left-2 md:-left-12 bg-black text-white p-4 shadow-xl z-20 animate-bounce" style={{ animationDuration: '3s' }}>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-white/70">Word, PDF, G-Form, Quizizz</div>
                  </div>
                </div>
              </div>
            </motion.div>
      ...
      <section className="py-12 border-y border-black/5 bg-white">
        <div className="container-main mx-auto px-6 text-center">
          <p className="text-sm font-medium text-gray-400 mb-8 uppercase tracking-widest">Mendukung Berbagai Format Evaluasi Pembelajaran</p>
          <div className="flex flex-wrap justify-center gap-8 md:gap-16">
            <div className="flex items-center gap-2">
              <CheckCircle className="w-5 h-5 text-gray-400" />
              <span className="text-lg font-medium text-gray-600">Pilihan Ganda</span>
            </div>
            <div className="flex items-center gap-2">
              <CheckCircle className="w-5 h-5 text-gray-400" />
              <span className="text-lg font-medium text-gray-600">Isian Singkat</span>
            </div>
            <div className="flex items-center gap-2">
              <CheckCircle className="w-5 h-5 text-gray-400" />
              <span className="text-lg font-medium text-gray-600">Esai Analisis</span>
            </div>
            <div className="flex items-center gap-2">
              <CheckCircle className="w-5 h-5 text-gray-400" />
              <span className="text-lg font-medium text-gray-600">Benar / Salah</span>
            </div>
            <div className="flex items-center gap-2">
              <CheckCircle className="w-5 h-5 text-gray-400" />
              <span className="text-lg font-medium text-gray-600">Menjodohkan</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container-main mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-20">
            ...
            <p className="text-lg text-gray-500">
              Setiap fitur dirancang dengan ketelitian tingkat tinggi untuk mengurangi beban administratif Anda.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              <div>
                <h3 className="text-2xl font-semibold text-black mb-3">Ekstraksi Dokumen Cerdas</h3>
                <p className="text-gray-500 text-lg leading-relaxed max-w-md">
                  Mesin pemroses bahasa alami kami dapat membaca PDF, Word, atau presentasi Anda dan mengisolasi konsep-konsep kunci tanpa merusak konteks aslinya.
                </p>
              </div>
            </motion.div>
            <motion.div 
            ...
            >
              ...
              <div>
                <h3 className="text-2xl font-semibold text-black mb-3">Penjawab Soal AI</h3>
            ...
            >
              ...
              <div>
                <h3 className="text-2xl font-semibold text-black mb-3">Generator Materi Super</h3>
                <p className="text-gray-500 text-lg leading-relaxed max-w-md">
                  Tidak ada bahan ajar? Cukup masukkan topik atau silabus. AI kami akan melakukan sintesis informasi dan menyusun materi pembelajaran terstruktur secara otomatis.
                </p>
              </div>
            </motion.div>
          </motion.div>
      ...
      <section className="py-32 px-6 bg-white border-t border-black/5">
        <div className="container-main mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-20">
            ...
            <p className="text-lg text-gray-500">
              Tiga langkah sederhana menuju efisiensi waktu yang belum pernah Anda rasakan sebelumnya.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
            ...
            <div className="relative text-center flex flex-col items-center">
              <div className="w-16 h-16 rounded-2xl bg-[#f5f5f7] flex items-center justify-center mb-6 relative z-10">
                <span className="font-editorial text-2xl font-bold text-black">1</span>
              </div>
              <h3 className="text-xl font-semibold text-black mb-3">Unggah Materi</h3>
              <p className="text-gray-500 leading-relaxed">Masukkan dokumen PDF, presentasi, atau ketikkan teks materi Anda ke dalam sistem.</p>
            </div>
            <div className="relative text-center flex flex-col items-center">
              <div className="w-16 h-16 rounded-2xl bg-black flex items-center justify-center mb-6 relative z-10 shadow-xl shadow-black/20">
                <span className="font-editorial text-2xl font-bold text-white">2</span>
              </div>
              <h3 className="text-xl font-semibold text-black mb-3">AI Menganalisis</h3>
              <p className="text-gray-500 leading-relaxed">Pilih tingkat kesulitan dan tipe soal. AI kami akan membedah materi dan merakit soal secara cerdas.</p>
            </div>
            <div className="relative text-center flex flex-col items-center">
              <div className="w-16 h-16 rounded-2xl bg-[#f5f5f7] flex items-center justify-center mb-6 relative z-10">
                <span className="font-editorial text-2xl font-bold text-black">3</span>
              </div>
              <h3 className="text-xl font-semibold text-black mb-3">Ekspor Bebas Gesekan</h3>
              <p className="text-gray-500 leading-relaxed">Unduh siap cetak sebagai Word/PDF, atau jadikan kuis interaktif langsung di Google Form dan Quizizz dengan 1 klik.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container-main mx-auto max-w-3xl">
          ...
          >
            ...
            <p className="text-xl text-gray-400 font-light mb-12 max-w-xl mx-auto">
              Bergabunglah dengan ribuan pendidik yang telah mengubah cara mereka bekerja. Bebaskan diri Anda dari tugas administratif sekarang.
            </p>
            <Link href="/register" className="inline-flex items-center gap-2 bg-white text-black px-10 py-5 rounded-xl font-medium text-lg hover:bg-gray-100 transition-colors hover:scale-105 transform duration-200">
              Mulai Secara Gratis
