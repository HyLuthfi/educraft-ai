        ...
        <div className="space-y-8 sm:space-y-12 text-sm sm:text-base leading-relaxed">
          ...
          <section className="bg-white dark:bg-[#1e1e1e] border-2 border-black/15 dark:border-white/15 p-6 sm:p-8 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.1)]">
            ...
            <p className="text-gray-700 dark:text-gray-300">
              Selamat datang di EduCraft AI. Dengan mengakses atau menggunakan aplikasi web kami di <strong>https://educraft.saitech.co.id</strong>, Anda menyatakan bahwa Anda telah membaca, memahami, dan menyetujui untuk terikat oleh Syarat dan Ketentuan ini. Jika Anda tidak menyetujui ketentuan ini, Anda tidak diperkenankan menggunakan layanan kami.
            </p>
          </section>
